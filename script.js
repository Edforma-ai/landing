...
;(function() {
    ...
    */
    ...
    Boom.init = function() {
        ...
        */
        ...
        camera = new THREE.PerspectiveCamera( 90, window.innerWidth  / window.innerHeight, 1, 10)
        ...
        document.getElementById('main-heading').appendChild( renderer.domElement )
    ...
    ;(function(){
        ...
        */
        ...
        p.setStartPosition = function(){
            ...
            |
            */
            this.position.x = this.x  -195
            this.position.y = this.y  +125
            this.position.z = 0
        }
    ...
    */
    ...
    function drawImageToCanvas(canvas, img){
        ...
        image.onload = function() { // When the image is loaded
            canvas.canvas.width = image.width ; // Set canvas width to match image width
            canvas.canvas.height = image.height; // Set canvas height to match image height
            canvas.drawImage(image, 0, 0);  // Render image with its entire height and width
    
            // Call loadImage function after the image is loaded
            loadImage(img, image.width, image.height, function(){
                var canvas3d = new THREE.CSS3DObject(document.getElementById('base-canvas'))
                // Adjust the position to match the non-3D images
                canvas3d.position.set(0, 0, 0);
                scene.add(canvas3d);
        ...
        image.src = img; // Set the image source to start loading
    }
    ...
    */
    ...
    drawImageToCanvas(mainCanvas, 'text.png')
